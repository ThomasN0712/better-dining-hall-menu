...
const alwaysAvailableItems = [
  { item_name: "Scrambled Eggs", meal_type: "Breakfast", meal_type_id: 1 },
  { item_name: "Oatmeal", meal_type: "Breakfast", meal_type_id: 1 },
  { item_name: "Waffle Bar", meal_type: "Breakfast", meal_type_id: 1 },
  {
  ...
  { item_name: "Assorted Cereals", meal_type: "Breakfast", meal_type_id: 1 },
  { item_name: "Fresh Fruit", meal_type: "Breakfast", meal_type_id: 1 },
  { item_name: "Deli Bar", meal_type: "Breakfast", meal_type_id: 1 },
  {
  ...
  { item_name: "Assorted Fruit Juice", meal_type: "Lunch", meal_type_id: 2 },
  {
    item_name: "Milk and Non-Dairy Milk",
    meal_type: "Lunch",
    meal_type_id: 2,
  },
  { item_name: "Assorted Cereals", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Fresh Fruit", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Chef's Choice", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Salad Bar", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Deli Bar", meal_type: "Lunch", meal_type_id: 2 },
  {
    item_name: "Assorted Sparkling Water",
    meal_type: "Lunch",
    meal_type_id: 2,
  ...
  { item_name: "Assorted Soft Drinks", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Assorted Desserts", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Novelty Ice Creams", meal_type: "Lunch", meal_type_id: 2 },
  { item_name: "Assorted Fruit Juice", meal_type: "Dinner", meal_type_id: 3 },
  {
    item_name: "Milk and Non-Dairy Milk",
    meal_type: "Dinner",
    meal_type_id: 3,
  },
  { item_name: "Assorted Cereals", meal_type: "Dinner", meal_type_id: 3 },
  { item_name: "Fresh Fruit", meal_type: "Dinner", meal_type_id: 3 },
  { item_name: "Salad Bar", meal_type: "Dinner", meal_type_id: 3 },
  { item_name: "Deli Bar", meal_type: "Dinner", meal_type_id: 3 },
  { item_name: "Chef's Choice", meal_type: "Dinner", meal_type_id: 3 },
  {
    item_name: "Assorted Sparkling Water",
    meal_type: "Dinner",
    meal_type_id: 3,
  ...
  { item_name: "Assorted Soft Drinks", meal_type: "Dinner", meal_type_id: 3 },
];
...
const AlwaysAvailableCard: React.FC<AlwaysAvailableCardProps> = ({
  ...
  const backgroundStyle = {
    ...
    "--rainbow":
      "repeating-linear-gradient( 0deg,rgb(255,119, 2) calc(var(--step) * 1),rgba(255,237,95,1) calc(var(--step) * 2),rgba(168,255,95,1) calc(var(--step) * 3),rgba(131,255,247,1) calc(var(--step) * 4),rgba(120,148,255,1) calc(var(--step) * 5),rgb(216,117,255) calc(var(--step) * 6),rgb(255,119, 2) calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat",
    "--diagonal":
  ...
  return (
    <div
      ...
      className="relative isolate transition-transform duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
    ...
    >
      ...
      >
        ...
        <div className="grid h-full w-full mix-blend-soft-light [clip-path:inset(0_0_0_0_round_var(--radius))] [grid-area:1/1]">
          <div className="relative flex h-full w-full flex-col border border-background-borderLight bg-[#FFAF45] p-4 text-text-light shadow-lg dark:border-background-borderDark dark:bg-[#9b7527] dark:text-text-dark">
            {/* Header */}
            <div className="mb-4">
